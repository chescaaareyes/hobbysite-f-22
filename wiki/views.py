...
def article_list(request):
    ...
    user_articles = articles.filter(author=request.user) if request.user.is_authenticated else []
    other_articles = articles.exclude(author=request.user) if request.user.is_authenticated else articles
    ctx = {
